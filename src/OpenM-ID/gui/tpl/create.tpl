                ...
                <div class="col-md-4 openm-id-form">
                    <form class="form-signin" method="POST" action="{$action}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="mail" class="form-control" id="mail" value="{$mail}" placeholder="{#login_text_box#}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" class="form-control" name="password" id="password" placeholder="{#password_text_box#}">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" class="form-control" name="password2" id="password2" placeholder="{#password_text_box#}">
